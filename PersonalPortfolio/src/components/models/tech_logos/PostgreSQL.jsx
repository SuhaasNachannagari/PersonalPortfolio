...
const PostgreSQL = ({ model }) => {
  const scene = useGLTF('/models/PostGRES.glb');
  ...
  return (
    <Canvas>
      ...
      */}
<Float speed={5.5} rotationIntensity={.7} floatIntensity={0.9}>
  <group scale={[12, 12, 6]} rotation={model.rotation}>
